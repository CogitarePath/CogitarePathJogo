    ...
    public class PatrolEnemy : MonoBehaviour
{
    ...
    public Enemy SombradeBruxa = new Enemy("Sombra de Bruxa", 0.05f, 2f, 8, 10, true, false, false);
    public Enemy PlantaOlhodeGato = new Enemy("Planta Olho de Gato", 0.05f, 1.5f, 6, 16, true, false, false);
