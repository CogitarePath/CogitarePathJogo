...
public class ParkGenerator : Generators, IPlayerInteraction
{

    

    [SerializeField] ActivateLights activateLights;
    ...
    {
        base.LoadUsed();
        ActivateLights.generatorActive = true;
        if (ActivateLights.fuseActive)
        {
