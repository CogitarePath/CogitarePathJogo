...
public class PlayerMove : MonoBehaviour
{
    ...
    void Update()
    {
        Debug.Log(RenderSettings.fogStartDistance);
        Stamina.value = ActualStamina;
        if (freeze) return;
        GroundVerify();
        MyInput();
    ...
    public void DeathReset()
    {
        ...
        Flashlight.battery = FlashlightScript.maxBattery * 0.75f;

        SceneManager.LoadScene("Quarto");
        ScenePositionControl.sceneStartPosition = new Vector3(1.67999995f, -0.200000003f, 3.1400001f);
        SaveControl.savedSceneName = "Quarto";
        SaveControl.playerPosition = new Vector3(1.67999995f, -0.200000003f, 3.1400001f);
    }
}